...
public class PipelineCondition extends AbstractCondition {
  ...
  public boolean apply(@Nullable WorkflowContext input) {
    ...
    try {
      ...
      BasicArguments arguments = new BasicArguments(input.getToken(), input.getRuntimeArguments());
      ConditionContext conditionContext = new BasicConditionContext(input, metrics, stageSpec, arguments);
